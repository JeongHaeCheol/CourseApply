	...
	<sf:form method="post"
		...
		<table class="formtable">
			...
			<tr>
				...
				<td><sf:input class="control" type="text" path="term"/><br/>
					<sf:errors path="term" class="error" /></td>
			</tr>
			<tr>
				<td class="label">교과코드</td>
				<td><sf:textarea class="control" type="text" path="code" /><br/>
					<sf:errors path="code" class="error" /></td>
			</tr>
			<tr>
				<td class="label">교과목명</td>
				<td><sf:textarea class="control" type="text" path="name" /><br/>
					<sf:errors path="name" class="error" /></td>
			</tr>			
			<tr>
				<td class="label">구분</td>
				<td><sf:textarea class="control" type="text" path="category" /><br/>
					<sf:errors path="category" class="error" /></td>
			</tr>
			<tr>
				<td class="label">학점</td>
				<td><sf:textarea class="control" type="text" path="credit" /><br/>
					<sf:errors path="credit" class="error" /></td>
			</tr>
	
			<tr>
				<td class="label"></td>
				<td><input class="control" type="submit" value="신청" /></td>
			</tr>
		</table>
